...
class VisionGRPOVLLMTrainer(Trainer):
    def __init__(
        self,
        ...
        if is_deepspeed_zero3_enabled():
            if "Qwen2-VL" in model_id or "Qwen2.5-VL" in model_id:
                model_class = Qwen2VLForConditionalGeneration if "Qwen2-VL" in model_id else Qwen2_5_VLForConditionalGeneration
        ...
        if processing_class is None:
            ...
            warnings.warn("Processing class is provided, you need to set max_pixels and min_pixels yourself.")
    ...
    def _prepare_inputs(
        ...
        prompts_text_copy = copy.deepcopy(prompts_text)
        prompt_inputs = self.processing_class(
            # prompts_text, return_tensors="pt", padding=True, padding_side="left", add_special_tokens=False
            text=prompts_text_copy,
            images=images,
            return_tensors="pt",
            padding=True,
            padding_side="left",
